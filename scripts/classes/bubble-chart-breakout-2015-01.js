...
function getData() {
  ...
  var students = [
    ...
    {
      "aluno": "Gabriel Pires de Miranda Magalh�es",
    ...
    {
      "aluno": "Larissa de C�ssia Nazar� Bicalho",
    ...
    {
      "aluno": "Lucas Nascimento Huati Corr�a",
    ...
    {
      "aluno": "Luiz Fl�vio Costa de Lima",
    ...
    {
      "aluno": "Maria Ver�nica Santos Soares",
    ...
    {
      "aluno": "Vin�cius Henrique Silveira",
    ...
    {
      "aluno": "Vinicius Magalh�es D' Assun��o",
